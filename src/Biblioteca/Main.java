...
public class Main {
			...
			case 1:
				...
				while(gestoreCentrale.isLogin()){
					...
					while(sceltalogin!=4 && sceltalogin!=5){
						...
						switch(sceltalogin){
						case 1:
							gestoreCentrale.ricerca();
							break;
						case 2:
							gestoreCentrale.abbonamento();
							break;
						case 3:
							gestoreCentrale.suggerisciAcquisto();
							break;
						case 4:
	...
	/**
	 * Metodo che gestisce il menu del generico utente che può essere registrato o meno ma che sicuramente non 
