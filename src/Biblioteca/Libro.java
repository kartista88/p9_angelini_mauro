 ...
 *  e infine la disponibilit� al prestito e/o consultazione
 * @author Mauro
 *
 */
public class Libro {
	 ...
	 * @param disponibile Variabile booleana che indica se il libro � disponibile al prestito
	 ...
	 * @param annoEdizione Anno in cui� stato stampato il libro
	 */
	public Libro(boolean disponibile, String iSBN, String titolo, String autore, String casaEditrice, Integer annoEdizione) {
		super();
	...
	/**
	 * Metodo che ritorna vero se il libro � disponibile al prestito/consultazione viceversa falso
	 * @return	Variabile booleana che indica se il libro � disponibile al prestito
	 */
	public boolean isDisponibile() {
		return Disponibile;
	}
	/**
	 *  Metodo che permette di settare vero se il libro � disponibile al prestito/consultazione viceversa falso
	 * @param disponibile Variabile booleana che indica se il libro � disponibile al prestito
	 */
