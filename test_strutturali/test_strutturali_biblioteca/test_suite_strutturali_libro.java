...
public class test_suite_strutturali_libro {
	...
	public void testCostruttoreDefaultAnnoEdizione() {
		assertEquals("test costruttore default controllo anno edizione" , new Integer(0) , libroTestEmpty.getAnnoEdizione());
	}
	...
	public void testCostruttoreParametriAnnoEdizione() {
		assertEquals("test costruttore parametri controllo anno edizione" , new Integer(2017) , libroTest.getAnnoEdizione());
	}
	...
	public void testSetAnnoEdizione() {
		...
		assertEquals("test set anno edizione" , new Integer(2016) , libroTestEmpty.getAnnoEdizione());
	}
