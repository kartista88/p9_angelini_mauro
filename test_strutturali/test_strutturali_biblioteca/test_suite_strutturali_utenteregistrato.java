...
public class test_suite_strutturali_utenteregistrato {
	...
	@Test
	public void testCostruttoreDefaulEtà() {
		assertEquals("Test costruttore default controllo età" , null , utenteTestEmpty.getEtà());
	}
	...
	@Test
	public void testCostruttoreParametriEtà() {
		assertEquals("Test costruttore parametri controllo età" , "25" , utenteTest.getEtà());
	}
	...
	public void testSetEtà() {
		utenteTestEmpty.setEtà("23");
		assertEquals("Test set età" , "23" , utenteTestEmpty.getEtà());
	}
