...
public class test_suite_strutturali_gestore {
	...
	public void testCostruttoreDefaultIsLogin() {
		assertEquals("Test costruttore default controllo utente Ë login" , false , gestoreTestEmpty.isLogin());
	}
	...
	@Test
	public void testIscriviEt‡Errata() throws IOException {
		UtenteRegistrato utenteCorretto = new UtenteRegistrato("Michele","Angelini","14","Via piantelli 2A","michele25ge@gmail.com","3346599851335","michele","Michele.88");
	...
	@Test
	public void testCheckEt‡Corretta() {
		assertEquals("Test check et‡ corretta" , true , gestoreTest.checkEt‡("13"));
	}
	
	@Test
	public void testCheckEt‡NonCorretta() {
		assertEquals("Test check et‡ non corretta < 13" , false , gestoreTest.checkEt‡("12"));
	}
	
	@Test
	public void testCheckEt‡ErroreDigitazione() {
		assertEquals("Test check et‡ corretta" , false , gestoreTest.checkEt‡("1£"));
	}
