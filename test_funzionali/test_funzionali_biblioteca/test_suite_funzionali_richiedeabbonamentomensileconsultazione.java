 ...
 *
 */
public class test_suite_funzionali_richiedeabbonamentomensileconsultazione {
	...
	@Test
	public void testAbbonamentoSuccessoControlloPagamento() throws IOException {
		gestoreTest.abbonamento();
		assertEquals("Test abbonamento mensile successo controllo pagamento" , true , gestoreTest.getAbbonamenti().get(0).getPagato());
	}
	
	@Test
	public void testAbbonamentoSuccessoControlloUtente() throws IOException {
		gestoreTest.abbonamento();
		assertEquals("Test abbonamento mensile successo controllo utente" , gestoreTest.getUtentelogin() , gestoreTest.getAbbonamenti().get(0).getUtenteRegistrato());
	}
