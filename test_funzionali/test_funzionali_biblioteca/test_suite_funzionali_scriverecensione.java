...
public class test_suite_funzionali_scriverecensione {
	...
	@Test
	public void testScriviRecensioneFallimentoVotoSopraSoglia() throws IOException {
		assertEquals("Test recensione fallimento voto sopra soglia" , false , gestoreTest.recensione(0, 0 , "Bello", libroTest));
	}
	
	@Test
	public void testScriviRecensioneFallimentoVotoSottoSoglia() throws IOException {
		
		assertEquals("Test recensione fallimento voto sotto soglia" , false , gestoreTest.recensione(0, 6 , "Bello", libroTest));
	}
