...
public class test_suite_funzionali_iscriversi {
	...
	@Test
	public void testIscrizioneErrataEt‡() throws IOException {
		UtenteRegistrato utenteEt‡Errata= new UtenteRegistrato("Paolo" , "Angelini" , "12" , "Via piantelli 2A" , "paolo88ge@gmail.com" , "356888569852" , "paolo" , "Paolo.88");
		gestoreTest.iscrivi(utenteEt‡Errata);
	...
	public void testIscrizioneErrataUsername() throws IOException {
		...
		assertEquals("Test iscrizione username errata" , utenteUserNameErrato , gestoreTest.getUtentiRegistrati().get(1));
	}
